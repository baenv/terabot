defmodule TradingSystemMain.MixProject do
  ...
  defp deps do
    [
      ...
      {:gettext, github: "elixir-lang/gettext", tag: "v0.20.0", override: true},
      ...
      {:cowlib, git: "https://github.com/ninenines/cowlib", ref: "2.12.1", override: true},
      ...
      {:ecto_sql, github: "elixir-ecto/ecto_sql", tag: "v3.10.1", override: true},
      ...
      {:statistex, github: "msharp/elixir-statistics", tag: "v0.4", only: :dev, runtime: false, override: true},
      {:deep_merge, github: "PragTob/deep_merge", tag: "1.0.0", only: :dev, runtime: false, override: true},
      {:xla, github: "elixir-nx/xla", tag: "v0.5.0", only: :dev, runtime: false, override: true},
      {:dll_loader_helper, github: "elixir-nx/dll_loader_helper", tag: "1.1.0", only: :dev, runtime: false, override: true}
    ]
  end
