defmodule WebDashboard.Telemetry do
  ...
  def metrics do
    [
      ...
      summary("portfolio_manager.balance.update.duration",
        unit: {:native, :millisecond},
        description: "Time taken to update balances"
      ),
      summary("portfolio_manager.transaction.process.duration",
        unit: {:native, :millisecond},
        description: "Time taken to process transactions"
      ),
      
      # Order Manager Metrics
      summary("order_manager.order.execute.duration",
        unit: {:native, :millisecond},
        description: "Time taken to execute orders"
      ),
      summary("order_manager.order.cancel.duration",
        unit: {:native, :millisecond},
        description: "Time taken to cancel orders"
      ),
