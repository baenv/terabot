defmodule PortfolioManager.UniswapAdapter do
  @moduledoc """
  Adapter for managing Uniswap-based portfolios.
  ...
  @doc """
  Gets the token price from Uniswap.
  ...
  def init(_opts) do
    ...
    factory_address = get_uniswap_factory_address()
    router_address = get_uniswap_router_address()
  ...
  defp get_uniswap_factory_address do
    System.get_env("UNISWAP_FACTORY_ADDRESS")
  end

  defp get_uniswap_router_address do
